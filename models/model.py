...
class Network(nn.Module):
    ...
    def forward(self, img, txt, mask):
        ...
        txt3, txt41, txt42, txt43, txt44, txt45, txt46 = self.model_txt(txt)  # txt4: batch x 2048 x 1 x 64
        txt_f3, _ = txt3.max(1)
        txt_f41, _ = txt41.max(1)
        txt_f42, _ = txt42.max(1)
        txt_f43, _ = txt43.max(1)
        txt_f44, _ = txt44.max(1)
        txt_f45, _ = txt45.max(1)
        txt_f46, _ = txt46.max(1)
        txt_f4, _ = torch.stack([txt_f41, txt_f42, txt_f43, txt_f44, txt_f45, txt_f46], dim=2).max(1)
